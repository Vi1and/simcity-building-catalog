...
export const catalogThemes = [
  ...
  {
    id: 'scandinavia',
    label: 'Скандинавия и Север',
    icon: '🇳🇴',
    description: 'Норвегия, Финляндия, Исландия, Швеция и северная архитектура',
    seasons: [19, 32, 36, 61],
    keywordPrefixes: ['норвеж', 'финск', 'исланд', 'швед', 'датск', 'скандинав', 'викинг', 'драккар', 'лапланд', 'norway', 'norwegian', 'finland', 'finnish', 'iceland', 'sweden', 'swedish', 'denmark', 'danish', 'scandinav', 'viking', 'longship', 'lapland'],
  },
  {
    id: 'central-europe',
  ...
  },
  {
    ...
    label: 'Ирландия',
    icon: '🇮🇪',
    description: 'Замки, аббатства и природные памятники Ирландии',
    seasons: [39],
    keywordPrefixes: ['ирланд', 'ireland', 'irish'],
